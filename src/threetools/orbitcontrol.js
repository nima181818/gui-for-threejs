	...
	initOrbitControls() {
		THREE.OrbitControls = function(e, t) {
			...
			void 0 === t && console.warn('THREE.OrbitControls: The second parameter "domElement" is now mandatory.'), t === document && console.error('THREE.OrbitControls: "document" should not be used as the target "domElement". Please use "renderer.domElement" instead.'), this.object = e, this.domElement = t, this.enabled = !0, this.target = new THREE.Vector3, this.minDistance = 0, this.maxDistance = 1 / 0, this.minZoom = 0, this.maxZoom = 1 / 0, this.minPolarAngle = 0, this.maxPolarAngle = Math.PI, this.minAzimuthAngle = -1 / 0, this.maxAzimuthAngle = 1 / 0, this.enableDamping = !1, this.dampingFactor = .05, this.enableZoom = !0, this.zoomSpeed = 1, this.enableRotate = !0, this.rotateSpeed = 1, this.enablePan = !0, this.panSpeed = 1, this.screenSpacePanning = !1, this.keyPanSpeed = 7, this.autoRotate = !1, this.autoRotateSpeed = 2, this.enableKeys = !0, this.keys = {
				...
				r.target.copy(r.target0), r.object.position.copy(r.position0), r.object.zoom = r.zoom0, r.object.updateProjectionMatrix(), r.dispatchEvent(s), r.update(), m = l.NONE
			...
			var r = this,
				...
				N = new THREE.Vector2,
				A = new THREE.Vector2;
          //  r.domElement =document.getElementsByClassName('rightwrapper')[0]
			function L() {
			...
			var M, C = (M = new THREE.Vector3, function(e, t) {
				...
				S = function() {
					...
					return function(t, o) {
						!0 === r.screenSpacePanning ? e.setFromMatrixColumn(o, 1) : (e.setFromMatrixColumn(o, 0), e.crossVectors(r.object.up, e)), e.multiplyScalar(t), T.add(e)
					}
				}(),
				k = function() {
					var e = new THREE.Vector3;
					return function(t, o) {
						...
						} else r.object.isOrthographicCamera ? (C(t * (r.object.right - r.object.left) / r.object.zoom / n.clientWidth, r.object.matrix), S(o * (r.object.top - r.object.bottom) / r.object.zoom / n.clientHeight, r.object.matrix)) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."), r.enablePan = !1)
					}
				}();

			function Y(e) {
				r.object.isPerspectiveCamera ? b /= e : r.object.isOrthographicCamera ? (r.object.zoom = Math.max(r.minZoom, Math.min(r.maxZoom, r.object.zoom * e)), r.object.updateProjectionMatrix(), O = !0) : (console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."), r.enableZoom = !1)
			}
			...
			function B(e) {
				if(!1 !== r.enabled) switch(e.preventDefault(), m) {
					case l.ROTATE:
						if(!1 === r.enableRotate) return;
						! function(e) {
							R.set(e.clientX, e.clientY), g.subVectors(R, f).multiplyScalar(r.rotateSpeed);
							var t = r.domElement;
							w(2 * Math.PI * g.x / t.clientHeight), j(2 * Math.PI * g.y / t.clientHeight), f.copy(R), r.update()
						}(e);
						break;
					case l.DOLLY:
						if(!1 === r.enableZoom) return;
						! function(e) {
							N.set(e.clientX, e.clientY), A.subVectors(N, P), A.y > 0 ? Y(L()) : A.y < 0 && D(L()), P.copy(N), r.update()
						}(e);
						break;
					case l.PAN:
						if(!1 === r.enablePan) return;
						! function(e) {
							v.set(e.clientX, e.clientY), y.subVectors(v, H).multiplyScalar(r.panSpeed), k(y.x, y.y), H.copy(v), r.update()
						}(e)
				}
			}

			function G(e) {
				!1 !== r.enabled && (document.removeEventListener("mousemove", B, !1), document.removeEventListener("mouseup", G, !1), r.dispatchEvent(E), m = l.NONE)
			}

			function K(e) {
				!1 === r.enabled || !1 === r.enableZoom || m !== l.NONE && m !== l.ROTATE || (e.preventDefault(), e.stopPropagation(), r.dispatchEvent(u), function(e) {
					e.deltaY < 0 ? D(L()) : e.deltaY > 0 && Y(L()), r.update()
				}(e), r.dispatchEvent(E))
			}

			function W(e) {
				!1 !== r.enabled && !1 !== r.enableKeys && !1 !== r.enablePan && function(e) {
					var t = !1;
					switch(e.keyCode) {
						case r.keys.UP:
			...
			function Q(e) {
				if(!1 !== r.enabled) switch(e.preventDefault(), e.stopPropagation(), m) {
					case l.TOUCH_ROTATE:
						if(!1 === r.enableRotate) return;
						_(e), r.update();
						break;
		...
		}, THREE.MapControls.prototype = Object.create(THREE.EventDispatcher.prototype), THREE.MapControls.prototype.constructor = THREE.MapControls,THREE.OrbitControls;
